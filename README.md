# mod_related_items with thumbnails in the override
...
To use this copy/extract the folder mod_related_items to the /html/ folder in your template. After select the layout "withimages" in your module administrator.
